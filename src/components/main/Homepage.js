            ...
            >
                ...
                >
                    ...
                    <div className="mt-3 mb-3" style={textStyle}>
                        <p>
                            A web of production platform, an online marketplace
                            that connects local producers and end-users.
                            End-users will have the ability to request the
                            production of a product via the platform.A web of
                            production platform, an online marketplace that
                            connects local producers and end-users. End-users
                            will have the ability to request the production of a
                    ...
                    <div className="mt-3" style={textStyle}>
                        <p>
                            ...
                            resources are waiting for your order. Do you have
